...
pcall(function()
    ...
    pcall(function()
        workspac
e:FindFirstChild(LocalPlayer.Name).Humanoid.Health = math.huge
    ...
    pcall(function()
        for _, v in pairs(workspace:FindFirstChild(LocalPlayer.Name):GetDescendants()) do
    ...
    if not pcall(function()
            ...
            elseif TORSOVELOCITY < 1 and HITFLOOR ~= nil then
                ...
                if ATTACK == false then
                    ...
                    RootJoint.C0 = Clerp(RootJoint.C0, ROOTC0 * CF(0, 0, 1.7 + ((1) - 1)) * ANGLES(RAD(0 + MRANDOM(-25,25) - 4 * COS(SINE / 12)), RAD(MRANDOM(-25,25)), RAD(0)), 1.5 / Animation_Speed)
            ...
            elseif TORSOVELOCITY > 1 and HITFLOOR ~= nil then
                ...
                if ATTACK == false then
                    ...
                    RightHip.C0 = Clerp(RightHip.C0, CF(1 , -1, 0) * ANGLES(RAD(0), RAD(90), RAD(0)) * ANGLES(RAD(0), RAD(0), RAD(0)), 2 / Animation_Speed)
                    LeftHip.C0 = Clerp(LeftHip.C0, CF(-1, -1, 0) * ANGLES(RAD(0), RAD(-90), RAD(0)) * ANGLES(RAD(0), RAD(0), RAD(0)), 2 / Animation_Speed)
                end
            end
