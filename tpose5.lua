...
game:GetService'RunService'.Stepped:Connect(function()
    ...
    if not pcall(function()
            ...
            RightHip = Torso["Right Hip"]
            LeftHip = Torso["Left Hip"]
            Humanoid.DisplayName = math.random()
            ...
            SINE = (tick() - start) * 30
                    ...
                    RightHip.C0 = Clerp(RightHip.C0, CF(1, -1, 0) * ANGLES(RAD(0), RAD(0), RAD(0)) * ANGLES(RAD(0), RAD(90), RAD(0)), 1)
                    LeftHip.C0 = Clerp(LeftHip.C0, CF(-1, -1 , 0) * ANGLES(RAD(0), RAD(0), RAD(0)) * ANGLES(RAD(0), RAD(-90), RAD(0)), 1)
        end) then
        owner:LoadCharacter()
    end
end)
